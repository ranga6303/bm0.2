...
export default function ManageCredentials({route}) {

    const {scrtype,usertype}=route.params;
    useEffect(()=>{
          ...
          <View style={styles.formContainer}>
            ...
            >
              <Text style={[styles.loginText, { color: Tnot.text }]}>
                {scrtype==='forgotpass'?"Search": 'Verify'}
              </Text>
            </TouchableOpacity>
             ...
             <View style={styles.smallBtnRow}>
              ...
              <TouchableOpacity onPress={handleRegOrFor}>
                <Text style={[styles.smallBtn, { color: T.primary }]}>
                 {scrtype==='forgotpass'?"": 'Already Registered?'}
                </Text>
              </TouchableOpacity>
            </View>
